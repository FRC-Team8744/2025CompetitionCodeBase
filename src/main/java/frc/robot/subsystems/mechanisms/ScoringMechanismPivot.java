...
public class ScoringMechanismPivot extends SubsystemBase {
   ...
   */
  // Sets m_scoringMechPivot to the angle degree(0-360) to a number(0-1) 
  public void rotatePivot(double angle) {
    // Ensures the angle is between the minimum and maximum
  ...
  // Returns the position of the angle
