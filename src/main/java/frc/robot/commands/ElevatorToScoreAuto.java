...
public class ElevatorToScoreAuto extends Command {
  ...
  public ElevatorToScoreAuto(Elevator ele, DriveSubsystem dr, ScoringMechanismPivot scp) {
    m_elevator = ele;
  ...
  public boolean isFinished() {
    if (m_elevator.isAtSetpoint() && m_robotDrive.autoXSpeed == 0 && m_robotDrive.autoYSpeed == 0) {
      return true;
    }
    else {
      return false;
