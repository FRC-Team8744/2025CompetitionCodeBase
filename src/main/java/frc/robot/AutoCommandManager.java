...
public class AutoCommandManager {
    ...
    public void configureNamedCommands(
        ...
        NamedCommands.registerCommand("ScoreCoral", new AutoScore(m_coralScoring, m_elevator, m_intake, m_intakePivot, m_scoringMechSensor).finallyDo((() -> {Constants.isAutoYSpeed = false; Constants.isAutoRotate = Constants.isAutoRotate == RotationEnum.STRAFEONTARGET ? RotationEnum.NONE : RotationEnum.STRAFEONTARGET;})));  
        NamedCommands.registerCommand("LEDS", Commands.runOnce(() -> m_leds.SetSegmentByVision(Constants.hasReachedX, Constants.hasReachedY, Constants.isAutoYSpeed, Constants.isAutoXSpeed, Color.kRed, ColorInterface.L1, ColorInterface.L1, Color.kBlue, 50)));      
